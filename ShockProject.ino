...
Timer timer(5000); // Create a timer object with a duration of 5000 milliseconds (5 seconds)
...
void loop() 
{
  ...
  //   Serial.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAH");
  // }
  ...
  if (timer.isExpired() && CheckValues())
  {
    Shock();
    timer.reset();
  }  
